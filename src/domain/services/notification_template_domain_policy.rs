//! Domain policy for NotificationTemplate aggregate
//!
...
/// Domain policy for NotificationTemplate — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<NotificationTemplate>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type NotificationTemplateDomainPolicy = PermitAllPolicy<NotificationTemplate>;
