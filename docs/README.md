...
This directory contains documentation for the notification bounded context module.
...
backbone schema generate notification --target docs

# Generate OpenAPI spec only
backbone schema generate notification --target openapi
```
...
**Description:** Notification delivery and user preferences
